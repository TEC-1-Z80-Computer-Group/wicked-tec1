...
interface Tec1HeaderProps extends Tec1HeaderProps {
  worker: any;
}

const BaseTec1Header = ({ worker, className }: Stylable) =>{
  ...
  const handleUpload = (event: any) => {
    ...
    reader.onload = () => worker.postMessage({ type: 'UPDATE_MEMORY', value: reader.result });
...
<div>
  ...
  <input id="file-upload" type="file" accept=".hex" onChange={handleUpload} />
</div>
